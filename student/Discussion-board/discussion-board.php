		...
		<header>
			<div class="d-flex flex-row justify-content-between align-items-center align-content-center">
				<ul class="nav nav-tabs" style="width:80%">
					<li class="nav-item "><a id="allQuestionsLink" class="nav-link active " href="<?php $val = $_GET["id"]; echo "discussion-board.php?id=$val";?>">View All Questions</a></li>
				...
				</ul><button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modalAskQuestion" style="font-size:1.1em;width:20%">Ask Question</button>
			</div>
		</header>
		<div>
			<main class="d-flex flex-column justify-content-between align-items-center align-content-center" id="discussion">
				<?php
                    $courseID = $_GET["id"];
                    $sql = "SELECT * FROM discussions WHERE course_ID = $courseID ORDER BY discussion_ID desc";
