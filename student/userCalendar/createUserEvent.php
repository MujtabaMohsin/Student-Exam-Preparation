<?php
    ...
    $query = "INSERT INTO `user_events` (`calendar_ID`, `title`, `description`, `start`, `end`, `allDay`) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    if ($stmt->execute()) {
        ...
        $query = "INSERT INTO `reminders` (`event_type`, `event_ID`, `start_time`, `end_time`) VALUES ('user_events', ?, ?, ?)";
